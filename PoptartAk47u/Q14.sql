...
INSERT INTO CUSTOMER(Custid, Fname,Email, Lname) VALUES (511, 'John','Johnwew@gmail.com' ,'Doe');
INSERT INTO CUSTOMER(Custid, Fname,Email, Lname) VALUES (512, 'Jane', 'Janewew@gmail.com','Smith');
INSERT INTO CUSTOMER(Custid, Fname,Email, Lname) VALUES (513, 'Robert', 'Robertwew@gmail.com','Brown');


	INSERT INTO PRODUCT(Productid,Category) VALUES (1111, 'Electronics');
	INSERT INTO PRODUCT(Productid,Category) VALUES (1110, 'Home Decor');
	INSERT INTO PRODUCT(Productid,Category) VALUES (1113, 'Apparel');
	INSERT INTO PRODUCT(Productid,Category) VALUES (1114, 'Music Instruments');
	INSERT INTO PRODUCT(Productid,Category) VALUES (1115, 'Accessories');
	INSERT INTO PRODUCT(Productid,Category) VALUES (1116, 'Footwear');
	INSERT INTO PRODUCT(Productid,Category) VALUES (1117, 'Books');
	INSERT INTO PRODUCT(Productid,Category) VALUES (1118, 'Home Decor');
	INSERT INTO PRODUCT(Productid,Category) VALUES (1119, 'Sports');

	INSERT INTO ORDER_(Orderid, Custid)VALUES (601, 511);
	INSERT INTO ORDER_(Orderid, Custid)VALUES (602, 512);
	INSERT INTO ORDER_(Orderid, Custid) VALUES (603, 513);
	INSERT INTO ORDER_(Orderid, Custid) VALUES (604, 511);
	INSERT INTO ORDER_(Orderid, Custid)VALUES (605, 513);

INSERT INTO ORDERITEM(Orderitemid, Orderid, Productid) VALUES (71, 601, 1111); 
INSERT INTO ORDERITEM(Orderitemid, Orderid, Productid) VALUES (72, 601, 1110); 
INSERT INTO ORDERITEM(Orderitemid, Orderid, Productid) VALUES (73, 601, 1113); 
INSERT INTO ORDERITEM(Orderitemid, Orderid, Productid) VALUES (74, 601, 1114); 
INSERT INTO ORDERITEM(Orderitemid, Orderid, Productid) VALUES (75, 601, 1115); 
INSERT INTO ORDERITEM(Orderitemid, Orderid, Productid) VALUES (76, 601, 1116); 
INSERT INTO ORDERITEM(Orderitemid, Orderid, Productid) VALUES (77, 601, 1117); 
INSERT INTO ORDERITEM(Orderitemid, Orderid, Productid) VALUES (78, 601, 1118); 
INSERT INTO ORDERITEM(Orderitemid, Orderid, Productid) VALUES (79, 601, 1119); 


INSERT INTO ORDERITEM(Orderitemid, Orderid, Productid) VALUES (711, 602, 1111); 
INSERT INTO ORDERITEM(Orderitemid, Orderid, Productid) VALUES (721, 602, 1110); 
INSERT INTO ORDERITEM(Orderitemid, Orderid, Productid) VALUES (731, 602, 1113); 
INSERT INTO ORDERITEM(Orderitemid, Orderid, Productid) VALUES (741, 602, 1114); 
INSERT INTO ORDERITEM(Orderitemid, Orderid, Productid) VALUES (751, 602, 1115); 
INSERT INTO ORDERITEM(Orderitemid, Orderid, Productid) VALUES (761, 602, 1116); 
INSERT INTO ORDERITEM(Orderitemid, Orderid, Productid) VALUES (771, 602, 1117); 
INSERT INTO ORDERITEM(Orderitemid, Orderid, Productid) VALUES (781, 602, 1118); 
INSERT INTO ORDERITEM(Orderitemid, Orderid, Productid) VALUES (791, 602, 1119); 
