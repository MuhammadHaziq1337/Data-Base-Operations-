...
INSERT INTO ORDER_ (Custid, Creationtimestamp,TotalAmount, Orderid) VALUES (2, '2023-10-19 09:15:00', 103);
INSERT INTO ORDER_ (Custid, Creationtimestamp, Orderid) VALUES (2, '2023-10-19 17:05:00', 104);
INSERT INTO ORDER_ (Custid, Creationtimestamp, Orderid) VALUES (2, '2023-10-19 19:35:00', 105);
INSERT INTO ORDER_ (Custid, Creationtimestamp, Orderid) VALUES (3, '2023-10-18 08:15:00', 106);
INSERT INTO ORDER_ (Custid, Creationtimestamp, Orderid) VALUES (3, '2023-10-18 08:25:00', 107);
INSERT INTO ORDER_ (Custid, Creationtimestamp, Orderid) VALUES (2, '2023-11-19 09:15:00', 108);
INSERT INTO ORDER_ (Custid, Creationtimestamp, Orderid) VALUES (2, '2023-11-29 17:05:00', 109);
INSERT INTO ORDER_ (Custid, Creationtimestamp, Orderid) VALUES (2, '2023-12-19 19:35:00', 110);
INSERT INTO ORDER_ (Custid, Creationtimestamp, TotalAmount,Orderid) VALUES(2, '2023-12-19 19:35:00',900.00, 112);


-- Q6 --
SELECT o.Custid, CAST(o.Creationtimestamp AS DATE) AS PurchaseDate, COUNT(o.Orderid) AS NumberOfOrders
FROM ORDER_ o
GROUP BY o.Custid, CAST(o.Creationtimestamp AS DATE)
