...
(2222, 'Accessories', 50.00),
(3333, 'Apparel', 25.00),
(4444, 'Books', 10.00),
(5555, 'Electronics', 200.00),
(6666, 'Footwear', 60.00),
(7777, 'Home Decor', 40.00),
(8888, 'Music Instruments', 150.00),
(9999, 'Sports', 75.00);



INSERT INTO ORDER_(Orderid) VALUES (6011);
INSERT INTO ORDER_(Orderid) VALUES (6021);

INSERT INTO ORDERITEM (OrderItemid, Productid, Quantity) VALUES
(22221, 2222, 2), -- Sold 2 of Product 1
(2222, 3333, 1), -- Sold 1 of Product 2
(2223, 4444, 4), -- Sold 4 of Product 3
(2224, 5555, 3), -- Sold 3 of Product 4
(2225, 6666, 5), -- Sold 5 of Product 5
(2226, 7777, 3), -- Sold 1 of Product 6
(2227, 8888, 3), -- Sold 3 of Product 7
(2228, 9999, 2); -- Sold 2 of Product 9
...
SELECT 
    ...
    ISNULL(SUM(oi.Quantity * p.Price), 0) as TotalRevenue
FROM 
    PRODUCT p
LEFT JOIN 
